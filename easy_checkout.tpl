     ...
     <h2><?php echo $heading_title; ?></h2>
		...
		<div class="row">
			<div class="col-md-12">
			    ...
			    <p class="well login-checkout"><?php echo $text_returning_customer; ?> &nbsp;<a href="#" onclick="jQuery('.login-form').toggle();return false;" class="btn btn-danger"><?php echo $text_i_am_returning_customer; ?></a></p>
				...
				<div class="form-group col-md-4">
				    <input type="button" value="<?php echo $button_login; ?>" id="button-login" data-loading-text="<?php if (isset($text_loading)) echo $text_loading;else echo 'loading ...' ?>" class="btn btn-login" />
		...
		<div class="row box checkout_form box-container">
			...
			<div class="col-md-4"> <div class="your_order">
